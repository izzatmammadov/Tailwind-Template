...
export const Prices = () => {
  return (
    <section className='h-screen relative flex justify-center items-center text-white'>
        <h3 className='absolute top-10 text-xl font-bold text-center'>Our Pricing</h3>
        <div className="h-screen"><img className="h-screen w-screen filter grayscale "src={price}/></div>
    <section className='absolute top-30 flex flex-wrap w-full items-center justify-center gap-6'>
